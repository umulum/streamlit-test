...
stock_input = st.text_input("종목명 또는 코드 입력 :", '005930')
st.subheader('')
date_range = st.date_input("조회일 설정 :", [datetime.date(2020, 1, 1), datetime.date(2023, 8, 14)])
...
stock_code = stock_input if stock_input.isdecimal() else codeFromName(stock_input) 
